...
set :application, 'smartport'
set :deploy_user, 'deploy'
set :scm, :git
set :repo_url, 'git@github.com:ziazek/smartport.git'
set :notify_email, 'ziazek@gmail.com'
...
namespace :deploy do
  ...
  # set up backup gems
  # error on first deploy because the backup folder is not up yet
  # after 'deploy:setup_config', 'backup:setup'
  # after 'backup:setup', 'backup:setup_config'
